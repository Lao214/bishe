...
import com.example.mymusic.common.*;
import com.example.mymusic.common.pages.IPage;
import com.example.mymusic.common.req.*;
...
public class ManagerStockAction  {

    private static Logger logger = LoggerFactory.getLogger(ManagerStockAction.class);
    ...
    public WebPageResponse queryStockList(@RequestParam(defaultValue = "0") Integer offset, @RequestParam(defaultValue = "10") Integer limit,@RequestParam(defaultValue = "") String name) {
        WebPageResponse response =new WebPageResponse();
        StockParam stockParam =new StockParam();
        if(StringUtils.isNotEmpty(name)){
            stockParam.setName(name);
        }
        try {
